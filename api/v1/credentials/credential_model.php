...
if (isset($_POST['credential_username'])) {
    ...
    $username = apiEncryptCredentialEntry($username, $api_key_row ?? $api_key_decrypt_hash, $api_key_decrypt_password, $client_id ?? null);
...
if (isset($_POST['credential_password'])) {
    ...
    $password = apiEncryptCredentialEntry($password, $api_key_row ?? $api_key_decrypt_hash, $api_key_decrypt_password, $client_id ?? null);
