...
CREATE TABLE `api_keys` (
  ...
  `api_key_client_master_wrapped` varchar(512) DEFAULT NULL,
...
CREATE TABLE `files` (
  ...
  `file_encrypted` tinyint(1) NOT NULL DEFAULT 0,
  `file_encryption_iv` varbinary(12) DEFAULT NULL,
  `file_encryption_tag` varbinary(16) DEFAULT NULL,
  `file_sha256` varbinary(32) DEFAULT NULL,
  `file_mime_verified` varchar(100) DEFAULT NULL,
...
CREATE TABLE `logs` (
  ...
  PRIMARY KEY (`log_id`),
  KEY `idx_logs_ratelimit` (`log_type`,`log_action`,`log_ip`,`log_created_at`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `user_vault_unlock_methods` (
  ...
  `salt` varchar(64) NOT NULL,
  `wrapped_master_key` varchar(512) NOT NULL,
  `wrapped_privkey` varchar(512) DEFAULT NULL,
  ...
  `kdf_version` tinyint NOT NULL DEFAULT 2,
  `cose_alg` int DEFAULT NULL,
  ...
  `disabled_by_user_id` int DEFAULT NULL,
  `created_at` datetime NOT NULL,
  `last_used_at` datetime DEFAULT NULL,
...
CREATE TABLE `settings` (
  ...
  `config_agent_sso_enabled` tinyint(1) NOT NULL DEFAULT 0,
  `config_agent_sso_tenant_id` varchar(64) DEFAULT NULL,
  `config_agent_sso_client_id` varchar(64) DEFAULT NULL,
  `config_agent_sso_client_secret` varchar(512) DEFAULT NULL,
  ...
  `config_ratelimit_login_max` int(11) NOT NULL DEFAULT 10,
  `config_ratelimit_login_window` int(11) NOT NULL DEFAULT 600,
  `config_ratelimit_vault_max` int(11) NOT NULL DEFAULT 20,
  `config_ratelimit_vault_window` int(11) NOT NULL DEFAULT 600,
  `config_ratelimit_sso_max` int(11) NOT NULL DEFAULT 20,
  `config_ratelimit_sso_window` int(11) NOT NULL DEFAULT 600,
  `config_ratelimit_api_max` int(11) NOT NULL DEFAULT 30,
  `config_ratelimit_api_window` int(11) NOT NULL DEFAULT 600,
  `config_ratelimit_pwreset_max` int(11) NOT NULL DEFAULT 5,
  `config_ratelimit_pwreset_window` int(11) NOT NULL DEFAULT 3600,
  `config_vault_idle_ttl_seconds` int(11) NOT NULL DEFAULT 1800,
  `config_require_hardware_bound_authenticators` tinyint(1) NOT NULL DEFAULT 0,
  `config_vault_lockout_max_seconds` int(11) NOT NULL DEFAULT 3600,
...
CREATE TABLE `users` (
  ...
  `vault_consecutive_failures` int(11) NOT NULL DEFAULT 0,
  `vault_locked_until` datetime DEFAULT NULL,
