                    ...
                    <div class="row">
                        ...
                        while ($row = mysqli_fetch_assoc($sql)) {
                            ...
                            $files[] = [
                                'id'      => $file_id,
                                'name'    => $file_name,
                                'preview' => "file_download.php?id=$file_id&inline=1"
                            ];
                            ?>
                            ...
                            <div class="col-xl-2 col-lg-2 col-md-6 col-sm-6 mb-3 text-center">
                                ...
                                <a href="#" onclick="openModal(<?php echo count($files)-1; ?>)">
                                    <img class="img-thumbnail" src="<?php echo "file_download.php?id=$file_id&inline=1"; ?>" alt="<?php echo $file_reference_name ?>">
                                </a>
                                ...
                                <div>
                                    <div class="dropdown float-right">
                                        ...
                                        <div class="dropdown-menu">
                                            <a class="dropdown-item" href="<?php echo "file_download.php?id=$file_id"; ?>" download="<?php echo $file_name; ?>">
                                ...
                                foreach ($items as $item) {
                                    ...
                                    if ($item['kind'] === 'file') {
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <a href="<?php echo "file_download.php?id=$file_id&inline=1"; ?>" target="_blank">
                                                    <div class="media">
