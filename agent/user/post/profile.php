...
if (isset($_POST['edit_your_user_password'])) {
    ...
    mysqli_query($mysqli,"UPDATE users SET user_password = '$new_password', user_specific_encryption_ciphertext = '$user_specific_encryption_ciphertext', user_specific_encryption_ciphertext_v2 = NULL WHERE user_id = $session_user_id");
