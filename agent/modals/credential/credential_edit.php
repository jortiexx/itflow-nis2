            ...
            <div class="tab-pane fade show active" id="pills-credential-details<?php echo $credential_id; ?>">
                ...
                <div class="form-group">
                    ...
                    <div class="input-group">
                        ...
                        <input type="password" class="form-control" data-toggle="password" name="otp_secret" maxlength="1000" value="<?php echo $credential_otp_secret; ?>" placeholder="Insert secret key">
                        <div class="input-group-append">
                            <span class="input-group-text"><i class="fa fa-fw fa-eye"></i></span>
                        </div>
                    </div>
