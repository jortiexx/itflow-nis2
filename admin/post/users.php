...
if (isset($_POST['edit_user'])) {
    ...
    if (!empty($new_password)) {
        ...
        // Phase 10: keypair invalidated; privkey was wrapped under the old
        // password's KEK. Grants for old privkey become unreadable; lazy
        // backfill at next login regenerates them.
        mysqli_query($mysqli, "UPDATE users SET user_password = '$new_password', user_specific_encryption_ciphertext = '$user_specific_encryption_ciphertext', user_specific_encryption_ciphertext_v2 = NULL, user_pubkey = NULL, user_privkey_wrapped = NULL WHERE user_id = $user_id");
