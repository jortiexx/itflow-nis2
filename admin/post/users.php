...
if (isset($_POST['edit_user'])) {
    ...
    if (!empty($new_password)) {
        ...
        mysqli_query($mysqli, "UPDATE users SET user_password = '$new_password', user_specific_encryption_ciphertext = '$user_specific_encryption_ciphertext', user_specific_encryption_ciphertext_v2 = NULL WHERE user_id = $user_id");
        //Extended Logging
...
if (isset($_POST['archive_user'])) {
    ...
    // Archive user query - clear both v1 and v2 wrapped master keys
    mysqli_query($mysqli, "UPDATE users SET user_name = '$user_name (archived)', user_password = '$password', user_status = 0, user_specific_encryption_ciphertext = '', user_specific_encryption_ciphertext_v2 = NULL, user_archived_at = NOW() WHERE user_id = $user_id");
